/**
@api {get} /api/c/compapi/cc/get_sets_by_property/ get_sets_by_property
@apiName get_sets_by_property
@apiGroup API-CC
@apiVersion 1.0.0
@apiDescription 根据 set 属性获取 set
...
@apiParam {string} [set_envi_type] Set 环境类型
@apiParam {string} [set_service_status] Set 开放状态
