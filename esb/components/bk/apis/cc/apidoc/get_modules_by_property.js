/**
@api {get} /api/c/compapi/cc/get_modules_by_property/ get_modules_by_property
@apiName get_modules_by_property
@apiGroup API-CC
@apiVersion 1.0.0
@apiDescription 根据 set 属性查询模块
...
@apiParam {string} [set_service_type] Set 环境类型，多个以逗号分隔
